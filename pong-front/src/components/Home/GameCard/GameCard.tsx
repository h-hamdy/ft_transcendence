...
export function GameCard ( {TableType, GameType ,imgPath, Views}: Props ) {
    return (
        <>
            <div className="flex justify-center items-center w-full pr-10 pt-10 pl-10 pb-10 sm:pl-0 sm:pt-0">
                <div className="flex items-center pt-9 border bg-[#FFF] drop-shadow-md rounded-custom w-full sm:w-[380px] lg:h-[200px]">
