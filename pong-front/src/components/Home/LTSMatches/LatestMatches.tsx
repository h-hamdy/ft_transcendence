    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center pr-10 pl-10 pb-10 lg:pt-10">
                <div className="border bg-white drop-shadow-lg rounded-custom w-full h-[350px] scrollable-div-ver0  lg:h-[730px]">
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-6 p-3 pt-10 lg:pt-24 lg:pt-0 scrollable-div-ver7">
                        <GameRes/>
                        <GameRes/>
                        <GameRes/>
                        <GameRes/>
