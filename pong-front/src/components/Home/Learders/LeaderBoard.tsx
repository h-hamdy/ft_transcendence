...
export function LeaderBoard () {
    return (
        <>
        <div className="lg:flex lg:justify-center lg:items-center pt-10 p-10">
            <div className="flex flex-col border h-[730px] w-full lg:w-11/12 lg:h-[900px] rounded-custom drop-shadow-2xl bg-[#FFF]">
                <div className="flex justify-center items-center pt-12 text-blue-900 font-poppins text-2xl font-semibold leading-normal tracking-wider lg:text-4xl">Leader Board</div>
                ...
                <div className="flex pb-8 pr-10 pl-10 lg:p-0 lg-pt-6">
                    <SeeMore/>
                    <PlayerNum Number="13"/>
                </div>
            </div>
