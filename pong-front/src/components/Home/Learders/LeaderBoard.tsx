...
export function LeaderBoard () {
    return (
        ...
        <div className="pt-10 p-10">
            <div className="flex flex-col items-center border h-[730px] w-full rounded-3xl drop-shadow-2xl bg-[#FFF]">
                <div className="pt-12 text-blue-900 font-poppins text-2xl font-semibold leading-normal tracking-wider">Leader Board</div>
